...
export default function LoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    if (loginError) {
      // Email not confirmed — send OTP and move to verify step
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-1 text-sm">Forward smarter. Manage everything.</p>
        </div>
            ...
            <>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div className="flex justify-end">
                  <Link href="/forgot-password" className="text-xs text-[#4B6BF1] hover:underline">Forgot password?</Link>
                </div>
              ...
              <p className="mt-5 text-sm text-gray-500 dark:text-gray-400 text-center">
                No account?{' '}
                <Link href="/signup" className="text-[#4B6BF1] hover:underline font-medium">Sign up free</Link>
              </p>
            </>
          ) : (
            <>
