...
function SidebarContent({ userName, userEmail, onNav }: { userName: string; userEmail: string; onNav?: () => void }) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-3 py-4 border-t border-gray-800 space-y-1">
        <Link href="/account/profile" onClick={onNav}
    ...
    <>
      ...
      {open && (
        <div className="md:hidden fixed inset-0 z-50 flex">
          ...
          <div className="relative w-64 bg-gray-900 h-full shadow-2xl">
            ...
            <SidebarContent userName={userName} userEmail={userEmail} onNav={() => setOpen(false)} />
          </div>
        </div>
      )}
